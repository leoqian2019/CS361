...
package proj9EnglishHillisonQian.bantam.treedrawer;

import proj9EnglishHillisonQian.bantam.ast.Program;
...
public class Drawer
{
    ...
    public void draw(String sourceName, Program AST)
    {
        ...
        proj9EnglishHillisonQian.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj9EnglishHillisonQian.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
