...
package proj8EnglishHillisonQian.bantam.treedrawer;

import proj8EnglishHillisonQian.bantam.ast.Program;
...
public class Drawer
{
    ...
    public void draw(String sourceName, Program AST)
    {
        ...
        proj8EnglishHillisonQian.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj8EnglishHillisonQian.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
