/*
 * File: proj6EnglishHillisonQian.TabHelper.java
    ...
    public void createCodeAreaForTab(Tab tab) {
        ...
        codeArea.setOnKeyTyped(event -> {
            ...
            String secondToLastCharBeforeCaret = codeArea.getText();
                ...
                if(codeArea.getCaretPosition()-2 > 0 && codeArea.getCaretPosition()-1>0){
                    secondToLastCharBeforeCaret = codeArea.getText(codeArea.
                            getCaretPosition()-2,codeArea.getCaretPosition()-1);
                }

            if(charTyped.equals("(")){
                getCurrentCodeArea().appendText(")");
                codeArea.displaceCaret(codeArea.getCaretPosition()-1);
                codeArea.moveTo(codeArea.getCaretPosition());
            }
        ...
        tab.setContent(ap);
        JavaKeywordHighlighter keywordColors= new JavaKeywordHighlighter(this.getCurrentCodeArea());
